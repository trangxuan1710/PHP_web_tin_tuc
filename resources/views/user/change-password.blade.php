<div class="bg-white rounded-lg shadow-lg p-8 mb-8">
        ...
        <form action="{{ route('profileChangePassword') }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="flex space-x-4">
                ...
                <button type="button" class="bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold py-3 px-6 rounded-md transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2">
                    Hủy
                </button>
            </div>
        </form>
