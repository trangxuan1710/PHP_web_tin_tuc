<header class="bg-white shadow-md py-5 px-6 md:px-10 lg:px-14 flex items-center justify-between rounded-b-lg space-x-8">
    <div class="flex items-center space-x-20 lg:space-x-20 w-3/4">
        <div class="flex items-center flex-shrink-0">
            <div
                class="w-8 h-8 bg-blue-600 rounded-full flex items-center justify-center text-white font-sans font-medium">
                N</div>
            <span class="ml-2 text-blue-800 text-xl font-bold font-sans whitespace-nowrap">Tin Tức 24/7</span>
        </div>
        ...
        <div class="flex items-center space-x-4 flex-1">
            ...
            <div
                ...
                <a href="#" class="text-gray-600 hover:text-blue-600 transition-colors duration-200 p-2 rounded-full
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 15 15">
    ...
    <div id="auth-buttons" class="flex items-center flex-1">
                <a href="#" class="text-blue-600 hover:text-blue-800 font-medium font-sans transition-colors duration-200 whitespace-nowrap">Đăng nhập</a>
                <span class="mx-2 text-gray-400">/</span>
                <a href="#" class="text-blue-600 hover:text-blue-800 font-medium font-sans transition-colors duration-200 whitespace-nowrap">Đăng ký</a>
            </div>
</header>