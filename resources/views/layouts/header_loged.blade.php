        ...
        <div class="relative">
            ...
            <div id="notification-dropdown-menu"
                ...
                <a href="#"
                    ...
                    <span class="font-bold font-sans">Tin mới:</span> Bài viết "Công nghệ AI đột phá" đã được đăng.
                    <span class="block text-xs text-gray-500">2 giờ trước</span>
                </a>
                <a href="#"
                    class="block px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-colors duration-200 text-sm">
                    <span class="font-bold font-sans">Cập nhật:</span> Chính sách bảo mật đã thay đổi.
                    <span class="block text-xs text-gray-500">Hôm qua</span>
                </a>
                <a href="#"
                    class="block px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-colors duration-200 text-sm text-center border-t border-gray-100">Xem
                    tất cả</a>
            </div>
        </div>
        <div id="user-profile" class="flex items-center space-x-2 cursor-pointer" aria-haspopup="true"
            aria-expanded="false">
            <img src="https://placehold.co/40x40/ADD8E6/000000?text=TX" alt="Avatar người dùng"
                class="w-10 h-10 rounded-full border-2 border-blue-400 object-cover">
            <span class="font-regular font-sans text-gray-800 hidden md:block whitespace-nowrap">Chào, Trang Xuân!</span>
            <div class="relative">
                ...
                <div id="user-dropdown-menu"
                    ...
                    <a href="#"
                        class="flex gap-3 px-3 py-2 text-red-600 hover:bg-red-50 hover:text-red-700 transition-colors duration-200"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
